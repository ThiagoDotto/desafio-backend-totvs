...
Acesse o keycloak no endereço localhost:8080 utilizando o usuário e senha admin.
...
1. Faça login com o usuário administrativo (por padrão, é admin com senha admin).
2. Criar um Realm
...
4. Agora vamos criar as Rols
   clique em Realms Roles no menu esquerdo, 
    ...
    create role
      - role name = spring-user-role e save.
5. Criar um Usuário
   No Keycloak Admin Console, vá para a seção "Users" no menu lateral.

    Clique em "Add User".
    Preencha o formulário com:
   - Username: apiuser Clique em "Save".
...
6. Agora vamos no menu Authentication
...
*** 
OBS: O sistema em Spring boot só funcionara quando o keycloak tiver configurado.